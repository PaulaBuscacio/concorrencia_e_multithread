...
/**
 * Exemplo de uso do Fork/Join Framework para calcular a soma de um grande array.
 * O array é dividido em partes menores, e cada parte é processada em paralelo.
 */
public class Ex1ForkJoinSumExample {
    ...
    static void main() {
        ...
        try (ForkJoinPool pool = ForkJoinPool.commonPool()) {
            ...
            println("Tempo de execução: " + (endTime - startTime) + " ms");
        }
    }
}